...
""")
    ...
    st.markdown('''
                ...
                <span class="big-font">
                The app utilizes the power of machine learning in order to predict the salary of a Software Developer given various parameters such as experience, education etc. and then calculates the salary based on those parameters. 
                <br>
                Finally, outputs the estimated result.
                <br>
                <br>
